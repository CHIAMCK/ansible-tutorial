...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "client" do |client|
	      ...
	      client.vm.synced_folder ".", "/home/vagrant/ansible-machine"
  end
  config.vm.define "server" do |server|
        server.vm.hostname = "server"
        server.vm.network "private_network", ip: "192.168.33.20"
	      server.vm.network "forwarded_port", guest: 8000, host: 1234, host_ip: "127.0.0.1"
  end
  config.vm.define "lb01" do |lb01|
        lb01.vm.hostname = "lb01"
        lb01.vm.network "private_network", ip: "192.168.33.21"
  end
  config.vm.define "app01" do |app01|
        app01.vm.hostname = "app01"
        app01.vm.network "private_network", ip: "192.168.33.22"
  end
